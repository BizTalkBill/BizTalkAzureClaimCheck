namespace AzureClaimCheck
{
    ...
    public sealed class AzureClaimCheckJSONSend : Microsoft.BizTalk.PipelineOM.SendPipeline
    {
...
"     <Components>        <Component>          <Name>Microsoft.BizTalk.Component.JsonEncoder,Microsof"+
"t.BizTalk.Pipeline.Components, Version=3.0.1.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35</Na"+
"me>          <ComponentName>JSON encoder</ComponentName>          <Description>JSON encoder componen"+
"t</Description>          <Version>1.0</Version>          <Properties>            <Property Name=\"Rem"+
"oveOuterEnvelope\">              <Value xsi:type=\"xsd:boolean\">false</Value>            </Property>  "+
"        </Properties>          <CachedDisplayName>JSON encoder</CachedDisplayName>          <CachedI"+
"sManaged>true</CachedIsManaged>        </Component>      </Components>    </Stage>  </Stages></Docum"+
"ent>";
        
        private const string _versionDependentGuid = "f827fd0d-2900-4238-8b43-2fd687e7f37e";
        
        public AzureClaimCheckJSONSend()
        {
...
"umentSpecTargetNamespaces,TargetCodePage</Value>    </Property>  </Properties></PropertyBag>";
            ...
            IBaseComponent comp1 = Microsoft.BizTalk.PipelineOM.PipelineManager.CreateComponent("Microsoft.BizTalk.Component.JsonEncoder,Microsoft.BizTalk.Pipeline.Components, Version=3.0.1.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35");;
