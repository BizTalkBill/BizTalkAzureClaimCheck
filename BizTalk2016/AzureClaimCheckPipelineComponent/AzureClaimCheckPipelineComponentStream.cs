//---------------------------------------------------------------------
// File: AzureClaimCheckPipelineComponentStream.cs
// 
...
namespace BizTalkBill
{
	...
	/// pipelines.
	/// </remarks>
	public class AzureClaimCheckPipelineComponentStream : Stream
	{
		...
		/// <summary>
		/// AzureClaimCheckPipelineComponentStream constructor.
		/// </summary>
		...
		public AzureClaimCheckPipelineComponentStream(Stream stm, byte[] prependData, byte[] appendData, ResourceManager resManager)
		{
			this.stm = stm;
